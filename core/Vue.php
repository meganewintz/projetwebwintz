...
class Vue {
    ...
    /**
     * @var $fichier : Nom du fichier associé à la vue
     */
    private $fichier;

    /**
     * @var $titre : Titre de la vue (défini dans le fichier vue)
     */
    private $titre;
    ...
    public function __construct($action, $controleur = "") {
        ...
        // La convention de nommage des fichiers vues est : app/views/<$controleur>/<$action>.php
        $fichier = "app/views/";
        if ($controleur != "") {
    ...
    public function generer($donnees) {
        ...
        array_key_exists('token',$donnees) ?
        $data = array('titre' => $this->titre, 'contenu' => $contenu,'racineWeb' => $racineWeb, 'token' => true)
        :
        $data = array('titre' => $this->titre, 'contenu' => $contenu,'racineWeb' => $racineWeb) ;
        // Génération du gabarit commun utilisant la partie spécifique
        $vue = $this->genererFichier('app/views/base.php', $data
                );
