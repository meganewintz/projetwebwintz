...
class Routeur {
    ...
    public function routerRequete() {
        try {
            ...
            $requete = new Requete(array_merge($_GET,array_merge($_POST, $_COOKIE)));
     ...
     * @return Controleur $controleur : instance d'un contrôleur
    ...
    private function creerControleur(Requete $requete) {
        ...
        if ($requete->existeParametre('controleur')) {
            ...
            // On force les minuscules sauf pour la premiere lettre
            $controleur = ucfirst(strtolower($controleur));
        }
        // Création du nom du fichier du contrôleur
        // La convention de nommage des fichiers controleurs est : app/controllers/Controleur<$controleur>.php
        $classeControleur = "Controleur" . $controleur;
        $fichierControleur = "app/controllers/" . $classeControleur . ".php";
    ...
    private function creerAction(Requete $requete) {
        $action = "render";  // Action par défaut
    ...
    /**
     * Gère une erreur d'exécution (exception) en affichant
     * le message d'erreur dansle navigateur.
     *
